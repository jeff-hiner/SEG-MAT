...
em++ -O2 -std=c++14 -s WASM=1 ^
    -s EXPORTED_FUNCTIONS="['_wasm_malloc','_wasm_free','_segmat_segment_buffer','_segmat_result_error_code','_segmat_result_face_count','_segmat_result_label_count','_segmat_result_labels']" ^
